...
path_12 = glob.glob('snap_L_500_TI_1.00*')[0]
path_tc = glob.glob('snap_L_500_TI_2.27*')[0]
path_10 = glob.glob('snap_L_500_TI_10.00*')[0]
...
for i in range(4):
    ...
    plt.xticks([], [])   
    plt.yticks([], [])
plt.savefig(f'imgs/all-img{L}.png', dpi=500)
